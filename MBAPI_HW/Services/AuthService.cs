...
using Microsoft.IdentityModel.Tokens; // 提供加密金鑰與簽章方法
using System.IdentityModel.Tokens.Jwt; // JWT Token 的處理器
...
namespace MBAPI_HW.Services
{
    public class AuthService : IAuthService
    {
        ...
        public string GenerateJwtToken(string userId, string role)
        {
             ...
             */
            _logger.LogInformation("【Info】產生JWT Token成功，UserId：{userId}，到期時間：{Expire}", userId, DateTime.UtcNow.AddMinutes(Convert.ToDouble(jwtSettings["ExpireMinutes"])).ToLocalTime());
